...
class ModernTCN(nn.Module):
    def __init__(self,patch_size,patch_stride, stem_ratio, downsample_ratio, ffn_ratio, num_blocks, large_size, small_size, dims, dw_dims,
                 nvars, small_kernel_merged=False, backbone_dropout=0.1, seq_len=120, channel=7, class_drop=0.,class_num = 10):
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.class_num =1 if configs.classes==2 else configs.classes
        ...
        self.model = ModernTCN(patch_size=self.patch_size, patch_stride=self.patch_stride, stem_ratio=self.stem_ratio,
                           ...
                           nvars=self.channel, small_kernel_merged=self.small_kernel_merged,
                           backbone_dropout=self.drop_backbone,seq_len=self.seq_len, channel=self.channel,
